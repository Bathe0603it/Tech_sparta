...
class Menu extends CI_Controller {
        ...
        public function __construct(){
                             ...
                             $this->load->model( array('admin/menu_model','admin/sitemaps_model') );
                             $this->admin_auth->check_login();
                             $this->config->load('position_templates',true);
                             $this->position = $this->config->item('position', 'position_templates');
        ...
        {                 $data['position']    = $this->position;
                          ...
                          if( !isset( $get['position'] ) )  $get['position']       = null;
        ...
        public function add()
        {
                          ...
                          { 
                            if( $this->form_validation->run('add_menu') == true )
                            {
                                ...
                                //$this->sitemaps_model->Db_addsitemaps($insert['slug']);
        ...
        public function edit()
        {
                          ...
                          if( $_POST )
                          {
                            if( $this->form_validation->run('edit_menu') == true )
                            {
                                ...
                                $current_menu = $this->menu_model->db->where('id',$get['id'])->get('menu')->row_array();
                                $this->menu_model->db->where('id',$get['id'])->update('menu',$update);
                                $this->sitemaps_model->Db_addsitemaps($update['slug'],$current_menu['slug']);
...
//            exit(); 
        ...
        public function get_position()
        {
            $mang = array(
                           ...
                           array( 'name'=>'left', 'title' => 'bên trái' ),
