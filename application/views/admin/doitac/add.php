...
<article>
    ...
    <form name="adminForm" id="form" action="" method="post">
        <header class="header_control">
            <label>Thêm Đối tác</label>
            <ul>
                <li><a href="#" onclick="submit_form('<?php echo base_url('admin/'.$this->router->fetch_class().'/'.$this->router->fetch_method().'?act=save_close');?>')" class="button">Lưu & đóng</a></li>
                ...
                <div class="tabs_left">
                    ...
                    <div class="field">
                        ...
                        <select name="state" class="form_control">
                            ...
                            <option value="" <?php echo set_select('state',0) ?>>Không kích hoạt</option>
                        </select>
                    </div>
                    <div class="field">
